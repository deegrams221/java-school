...
@Order(Ordered.HIGHEST_PRECEDENCE)  // most important adviser
@ControllerAdvice   // Bean that gives controller advice - shared across all controller Beans
public class RestExceptionHandler extends ResponseEntityExceptionHandler
{
    // constructor
    public RestExceptionHandler()
    {
        super(); // calls the top constructor
    }

    // ResourceNotFoundException - a resource is not found
    ...
    // handleTypeMismatch - the wrong data type is used for a path variable
    @Override
    ...
    // NoHandlerFoundException - a non-handled endpoint is accessed (a URL not found exception)
    @Override
